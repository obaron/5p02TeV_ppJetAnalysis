...
int bayesUnfoldDataSpectra( std::string inFile_Data_dir , std::string inFile_MC_dir   , std::string baseName , 
  ...
  if(dokIterQA){
    ...
    for(int ki=0; ki<nKiterMax;ki++){
      ...
      hgen_unf_ratio[ki]->SetTitle(("Data Unf./PY8 Truth, kIter="+std::to_string(current_kIter)+"; Jet p_{T}; ratio").c_str());
      ...
      hgen_fold_ratio[ki]->SetTitle(("Data Fold./PY8 Truth, kIter="+std::to_string(current_kIter)+"; Jet p_{T}; ratio").c_str());
