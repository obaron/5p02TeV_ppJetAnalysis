...
// CODE --------------------------------------------------
int SVDUnfoldDataSpectra_wNLO_etabin( const int etabinint=0, const int kRegInput=5,
				      std::string baseName="SVD_test" , 
  ...
  //const int kRegInput=5 ){//, //const int etabinint=0){
...
//		      &outRootFile);
  ...
  if(applyNPCorrs)TH2_title+="_NP_th2";
  else TH2_title+="_th2";
  ...
  hfold_truth->SetTitle(("Fold. Toy NLO Truth, kReg="+std::to_string(kRegInput)).c_str());
...
//  hfold_CT10nlo->SetName("ppMC_SVDFoldCT10nlo_Spectra");
...
//  if(debugWrite)unfmat_TH2->Write();
  ...
  if(dokRegQA){
    ...
    for(int ki=0; ki<nKregMax;ki++){
      ...
      hgen_unf_ratio[ki]->SetTitle(("Data Unf./Toy NLO Truth, kReg="+std::to_string(current_kReg)+"; Jet p_{T}; ratio").c_str());
      ...
      hgen_fold_ratio[ki]->SetTitle(("Data Fold./Toy NLO Truth, kReg="+std::to_string(current_kReg)+"; Jet p_{T}; ratio").c_str());
...
//    std::cout<<"do ./SVDUnfoldDataSpectra_wNLO_etabin.exe <etabinint ><targDataDir> <targMCDir> <targMCName> <baseOutputName> <applyNPCorrs> <doJetID> <useSimpleBins> <kRegInput>"<<std::endl;
//    return rStatus;  }  
//  if(argc==10){
//    rStatus=SVDUnfoldDataSpectra_wNLO_etabin( (int) std::atoi(argv[1]) ,  (const std::string)argv[2], (const std::string)argv[3], (const std::string)argv[4], (const std::string)argv[6], 
//					      (int)std::atoi(argv[6]),
//					      (int)std::atoi(argv[7]) , (int)std::atoi(argv[8]), (const int)std::atoi(argv[9]) );}//, (const int) std::atoi(argv[9]) );   }
//rStatus=SVDUnfoldDataSpectra_wNLO_etabin(  (const std::string)argv[1], (const std::string)argv[2], (const std::string)argv[3], (const std::string)argv[4], 
//						 (int)std::atoi(argv[5]),
//						 (int)std::atoi(argv[6]) , (int)std::atoi(argv[7]), (const int)std::atoi(argv[8]) , (const int) std::atoi(argv[9]) );   
  if(argc==2){
    rStatus=SVDUnfoldDataSpectra_wNLO_etabin(0,12,"SVD_NNPDF","smearTheory/NNPDF_NNLO_01.10.19_spl3wgts_gaussSmear_plots/","NNPDF_NNLO_01.10.19_spl3wgts_gaussSmear_");
    rStatus=SVDUnfoldDataSpectra_wNLO_etabin(1,12,"SVD_NNPDF","smearTheory/NNPDF_NNLO_01.10.19_spl3wgts_gaussSmear_plots/","NNPDF_NNLO_01.10.19_spl3wgts_gaussSmear_");
    rStatus=SVDUnfoldDataSpectra_wNLO_etabin(2,12,"SVD_NNPDF","smearTheory/NNPDF_NNLO_01.10.19_spl3wgts_gaussSmear_plots/","NNPDF_NNLO_01.10.19_spl3wgts_gaussSmear_");
    rStatus=SVDUnfoldDataSpectra_wNLO_etabin(3,12,"SVD_NNPDF","smearTheory/NNPDF_NNLO_01.10.19_spl3wgts_gaussSmear_plots/","NNPDF_NNLO_01.10.19_spl3wgts_gaussSmear_");

    rStatus=SVDUnfoldDataSpectra_wNLO_etabin(0, 12,"SVD_CT14","smearTheory/CT14_NLO_01.10.19_spl3wgts_gaussSmear_plots/","CT14_NLO_01.10.19_spl3wgts_gaussSmear_");
    rStatus=SVDUnfoldDataSpectra_wNLO_etabin(1, 12,"SVD_CT14","smearTheory/CT14_NLO_01.10.19_spl3wgts_gaussSmear_plots/","CT14_NLO_01.10.19_spl3wgts_gaussSmear_");
    rStatus=SVDUnfoldDataSpectra_wNLO_etabin(2, 12,"SVD_CT14","smearTheory/CT14_NLO_01.10.19_spl3wgts_gaussSmear_plots/","CT14_NLO_01.10.19_spl3wgts_gaussSmear_");
    rStatus=SVDUnfoldDataSpectra_wNLO_etabin(3, 12,"SVD_CT14","smearTheory/CT14_NLO_01.10.19_spl3wgts_gaussSmear_plots/","CT14_NLO_01.10.19_spl3wgts_gaussSmear_");
  }
  else {
    //std::cout<<"do ./SVDUnfoldDataSpectra_wNLO_etabin.exe <etabinint> <targDataDir> <targMCDir> <targMCName> <baseOutputName> <applyNPCorrs> <doJetID> <useSimpleBins> <kRegInput>"<<std::endl;
    return rStatus;
