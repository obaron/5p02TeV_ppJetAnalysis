...
const double fgaus_width_arr_15y20[]={
  0.28,// gen pt low edge =43., //garbage bins
  0.28,// gen pt low edge =49., //typical gen pt cut
  0.28,// gen pt low edge =56., //typical recopt cut
  0.28,// gen pt low edge =64.,
  0.28,// gen pt low edge =74.,
  0.22,// gen pt low edge =84.,
  0.21,// gen pt low edge =97.,
  0.21,// gen pt low edge =114.,
